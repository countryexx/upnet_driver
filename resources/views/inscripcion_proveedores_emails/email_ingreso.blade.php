			...
			<tr>
				<td>
					<table width="100%">
						...
						<tr>
							<td>
								<p class="asunto"><b>{{$nombre}}</b> se ha registrado en el portal de proveedores.</p>
							</td>
						</tr>
						<br>
									...
									<tr>
										<td>
											<table width="100%">
												<tr>
													<td style="text-align: center; padding: 15px 20px; color: #ffffff">
														<p class="names">Conductores: {{$totalConductores}}</p>
													</td>
													<td style="text-align: center; padding: 15px 20px; color: #ffffff">
														<p class="names">Vehículos: {{$totalVehiculos}}</p>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td>
											<table width="100%">
												<tr>
													<td style="text-align: center; padding: 15px 20px; color: #ffffff">
														<a href="https://www.upnetweb.com" class="buttonr">Ver Documentación</a>
													</td>
												</tr>
											</table>
										</td>
