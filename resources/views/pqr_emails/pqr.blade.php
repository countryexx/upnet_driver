	...
	<center class="wrapper">
		...
		<table class="main" width="100%">
			...
			<!-- BANNER IMAGE -->
				<tr>
					<td>
						<a href=""><img src="{{url('images/head.png')}}" alt="" width="600" style="max-width: 100%;"></a>
					</td>
				</tr>
			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td style="text-align: center; padding: 5px 10px; color: #ffffff">
							</td>
							<td style="text-align: center; padding: 5px 10px; color: #ffffff">
								<center>
								<div class="tops">
									<p class="respu">PQR # {{$id}}</p>
		        				</div>
		        				</center>
							</td>
							<td style="text-align: center; padding: 5px 10px; color: #ffffff">
			...
			<tr>
				<td>
					<table width="100%">
						<tr>
							<td>
								<p class="names">Sr(a) {{$solicitante}}</p>
							</td>
						</tr>
						<br>
						<tr>
							<td>
								<p class="asunto">Reciban un cordial saludo de parte del equipo de AOTOUR SAS. Lamentamos sinceramente la novedad presentada y las molestias ocasionadas. <br><br>Nuestro equipo se encuentra trabajando diligentemente para corregir la situación presentada y garantizar que no se repita en el futuro.<br><br> En esta oportunidad nos permitimos dar respuesta a la PQR recibida por parte de usted.</p>
							</td>
						</tr>
						<br>
						...
						<tr>
							<td>
								<table width="100%">
									<tr>
										<td>
											<img src="{{url('images/Image202.png')}}" width="100%">
										</td>
									</tr>
								</table>
							</td>
