			...
			<tr>
				<td>
					<table width="100%">
						...
						<tr>
							<td>
								<p class="namess">¡Ha sido rechazada!</p>
							</td>
						</tr>
						<br>
						<tr>
							<td>
								<p class="asunto">Esperamos contar contigo en otra oportunidad.</p>
							</td>
						</tr>
						<br>
						...
						<tr>
							<td style="text-align: center; padding: 15px 20px;">
								<img src="{{url('images/rechaz.png')}}" alt="" width="450" style="max-width: 100%;">
							</td>
						</tr>

						<tr>
							<td style="text-align: center; padding: 15px 20px;">
								<img class="footer-logo" src="{{url('images/footer-logo-black.png')}}" alt="" width="350" style="max-width: 100%;">
							</td>
						</tr>
